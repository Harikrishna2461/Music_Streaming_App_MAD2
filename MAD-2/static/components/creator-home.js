export default {
    ...
    <h1>Welcome to Creator Home Page :</h1>
    
    <div style="margin-bottom: 20px;">
        <button @click="goToWorkshop" :style="{ backgroundColor: 'green', marginRight: '10px' }">Go to Creator's Workshop</button>
    ...
    <div style="margin-bottom: 20px;">
        <button @click="filterSongs" style="background-color: turquoise; margin-right: 10px;">Filter Songs</button>
    ...
    computed: {
        albums() {
            ...
            this.songs.forEach(song => {
                if (!groupedSongs[song.album.name]) {
    ...
    methods: {
        ...
        goToWorkshop() {
            // Method to navigate to Workshop page
